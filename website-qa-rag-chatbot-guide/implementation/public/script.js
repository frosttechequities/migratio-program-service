document.addEventListener('DOMContentLoaded', () => {
  ...
  scrapeButton.addEventListener('click', async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        addMessage(`I've learned about ${websiteUrl}. You can now ask me questions about it!`, false);
      } else {
  ...
  // Initial message
  addMessage('Welcome! Enter a website URL above and click "Train" to get started.', false);
});

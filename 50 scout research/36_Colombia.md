# Comprehensive Immigration Research for Colombia

## Research Objective
Conduct comprehensive, real-time research on Colombia as an immigration destination, focusing on current (2025) immigration policies, programs, requirements, and practical considerations. The research should prioritize accuracy, recency, and practical applicability for potential immigrants.

## Research Requirements
Please provide detailed, factual, and up-to-date information on the following aspects of immigration to Colombia. Include specific data points, statistics from 2023-2025 where available, official sources, and practical insights:

### 1. Immigration Programs and Pathways
- Provide a comprehensive list of all current immigration programs in Colombia (M-type visas, R-type visas, V-type visas, Digital Nomad Visa, Retirement Visa, Investor Visa, etc.)
...
- List updated application fees and associated costs in Colombian Pesos
...
- Highlight any Colombia-specific document requirements based on applicant's country of origin
...
- Detail current medical examination requirements specific to Colombia
...
- List organizations currently authorized to evaluate foreign credentials for Colombia
- Explain how foreign education is evaluated against Colombian standards
...
- Identify current in-demand occupations in Colombia (2024-2025 data)
...
- Detail processes for obtaining cédula de extranjería and other essential documents
...
- Detail requirements for initial reporting after landing, including Migración Colombia registration
...
2. **Accuracy**: Use official government sources (Migración Colombia, Ministry of Foreign Affairs), reputable immigration organizations, and recent statistical reports
...
7. **Balanced Perspective**: Include both advantages and challenges of immigrating to Colombia
...
Based on Colombia's specific immigration context, please pay special attention to:
- Digital Nomad Visa program requirements and benefits
- M-type visa categories and their specific requirements
- Retirement visa financial requirements
- Regional differences in settlement opportunities
- Cédula de extranjería acquisition process and its importance

Thank you for conducting this thorough and up-to-date research on immigration to Colombia.

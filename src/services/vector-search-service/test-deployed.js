 ...
 * 
 * This script tests the deployed vector search service by making requests to the search and chat endpoints.
 */
...
async function runTests() {
  console.log(`Testing deployed vector search service at ${API_URL}`);
  console.log('-------------------------------------------');

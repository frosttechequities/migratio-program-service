 ...
 * 
 * API routes for the roadmap generator.
 */
 ...
 * @access Private
 */
router.get('/:roadmapId', auth, roadmapController.getRoadmap);
 ...
 * @access Private
 */
router.put('/:roadmapId', auth, roadmapController.updateRoadmap);
 ...
 * @access Private
 */
router.get('/:roadmapId/pdf', auth, roadmapController.generateRoadmapPDF);
